...
function EditPokemonModal({ pokemon }) {
    ...
    const [stats, setStats] = useState(
        pokemon.pokemon.stats.map((stat) => ({
            ...stat, // Ensure you're working with a copy of the stat objects
        }))
    );
...
// function EditPokemonModal({ pokemon, onClose }) {
//     const dispatch = useDispatch();
...
//             </div>
//             <button type="submit">Save</button>
//             <button type="button" onClick={onClose}>Cancel</button> {/* Use onClose here */}
//         </form>
//     );
// }
