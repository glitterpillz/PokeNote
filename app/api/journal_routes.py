...
@journal_routes.route('/<int:journal_id>/comments')
@login_required
...
@journal_routes.route('/comments/<int:comment_id>', methods=['PUT'])
@login_required
...
@journal_routes.route('/comments/<int:comment_id>', methods=['DELETE'])
@login_required
